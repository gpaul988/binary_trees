...
/**
 * swap - Exchanges two nodes in binary tree
 * @a: The first node
 * @b: The second node
 * Return: Directs to the origin
 * Author: Graham S. Paul (133-heap_extract.c)
 */
...
/**
 * binary_tree_size - Calculates the area of a binary tree
 * @tree: Insert binary tree
 * Return: Integer of progeny child nodes
 */
...
/**
 * swap_head - Assistant purpose to exchange head and node
 * @head: Directs to head
 * @node: Directs to node
 * Return: Directs to severed head of tree
 */
...
/**
 * perc_down - Filter head into rectifying location
 * @node: Directs to head
 * Return: Directs to head of tree
 */
...
/**
 * heap_extract - Remove the original node of a highest Binary Heap
 * @root: Dual direction to the origin of tree
 * Return: Worth saved in the origin node
 */
